<template>
  ...
  <div id="playlist">
   ...
   <div class="song" url-value="http://tegos.kz/new/mp3_full/Clean_Bandit_-_Symphony.mp3" picture-value="https://i.ytimg.com/vi/jtTI-XuW8i8/maxresdefault.jpg"> Clean Bandit &nbsp;∘&nbsp; Symphony</div>
   <div class="song" url-value="http://zaycev-mp3.net/mp3/linkin_park_powerless_[zaycev-mp3.net].mp3" picture-value="https://wallpapercave.com/wp/ufT9VZa.jpg">Linkin Park &nbsp;∘&nbsp; Powerless</div>
...
.song {
    ...
    height: 10%;
    padding: 0.5em;
    border-bottom: 0.5px solid #172951;
    font-size: 1.5rem;
    font-weight: bold;
    text-align: center;
    color: white;
